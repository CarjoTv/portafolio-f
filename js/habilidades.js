...
const habilidades = [
  ...
  {
    nombre: "JavaScript",
    icono: "/icons/javascript-programming-language-icon.svg",
  },
...
function cargarHabilidades() {
  ...
  habilidades.forEach((hab, index) => {
    ...
    div.className =
      "bg-slate-900/60 border border-white/10 rounded-2xl p-8 flex items-center justify-center hover:bg-slate-800 transition shadow-xl aspect-square opacity-0 translate-y-4";
